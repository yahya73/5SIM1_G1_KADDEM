...
export class StudentService {
  ...
  public assignStudent(idEtudiant:any,idDepart:any){
   ...
   public getDepartements(){
        ...
        return this.http.get<departement[]>('http://192.168.1.0:8082/kaddem/DepartmentController/displayalldepartment' );
  }

 public getallequipe() {
    return this.http.get<equipe[]>('http://192.168.1.0:8082/kaddem/EquipeController/displayEquipes' );
  }
